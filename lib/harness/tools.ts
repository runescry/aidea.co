  ...
  switch (toolName) {
        ...
        emails: [
          {
            ...
            subject: '[DRY RUN] Q3 budget proposal — approval needed',
            date: new Date().toISOString(),
            snippet: 'Please confirm your sign-off or any changes to the Q3 marketing budget by EOD.',
            ...(includeBody ? {
              bodyText: 'Hi,\n\nPlease confirm your sign-off or any changes to the Q3 marketing budget by EOD so I can finalise and circulate it.\n\nThanks,\nSarah',
              bodyTruncated: false,
            } : {}),
            isUnread: true,
          ...
          {
            id: 'mock-intro-1',
            from: 'James Okafor <james.okafor@ventures.io>',
            subject: '[DRY RUN] Introduction to Maya Rodriguez',
            date: new Date().toISOString(),
            snippet: 'Could you introduce me to Maya Rodriguez? I think Studio Co could be a strong design partner.',
            isUnread: true,
            connectionId: 'dry-run-gmail',
          },
          {
            id: 'mock-meridian-1',
            from: 'Lisa Park <lisa.park@meridian.health>',
            subject: '[DRY RUN] Meridian Health proposal — quick chase',
            date: new Date().toISOString(),
            snippet: 'Checking in on the proposal you said you would send by the end of this week.',
            isUnread: true,
            connectionId: 'dry-run-gmail',
          },
          {
            id: 'mock-offsite-1',
            from: 'People Team <hr@acmecorp.com>',
            subject: '[DRY RUN] Team offsite feedback',
            date: new Date().toISOString(),
            snippet: 'Please share any feedback from last week\'s team offsite by Friday.',
            isUnread: true,
            connectionId: 'dry-run-gmail',
          },
        ],
    ...
    case 'gmail_attachment_read': {
      ...
      return {
        ...
        connectionId: 'dry-run-gmail',
        attachments: [{
          filename: 'q3-marketing-budget.pdf',
          mimeType: 'application/pdf',
          size: 120_000,
          text: '[DRY RUN] Q3 marketing budget excerpt: reallocate £5,000 from events to paid social and include a 10% contingency line.',
          truncated: false,
        }],
        skipped: [],
      };
